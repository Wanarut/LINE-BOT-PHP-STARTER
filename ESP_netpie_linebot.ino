...
const char* host = "https://catbot-api.herokuapp.com/bot.php";//change this to your linebot server ex.http://numpapick-linebot.herokuapp.com/bot.php
#define APPID   "CATBOTAPI"     //change this to your APPID
#define KEY     "4JdrVKHP0nNC5rY"     //change this to your KEY
#define SECRET  "Gis4JiaQdi01XOHEFBiQ3xATa"     //change this to your SECRET

#define ALIAS   "CH1" //set name of drvice
